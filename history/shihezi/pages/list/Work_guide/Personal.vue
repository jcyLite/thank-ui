<template>
	<div class="personal">
		<div class="dept list">
			...
			<div @click="show_all_dept($event)" :class="[!dept_active?'glyphicon-chevron-down':'glyphicon-chevron-up']" class="bot glyphicon">
		...
		<div class="topi list">
			...
			<div @click="show_all_topi($event)" :class="[!topi_active?'glyphicon-chevron-down':'glyphicon-chevron-up']" class="bot glyphicon">
