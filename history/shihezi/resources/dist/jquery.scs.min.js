!function (a, b) {
    a.SCS = {version: "1.0.0"}, SCS.defaults = {
        navArr: [{title: "省", id: "scs_items_prov"}, {
            title: "市",
            id: "scs_items_city"
        }, {title: "区", id: "scs_items_dist"}], skinCss: "", onOk: function (a, b) {
        }, onCancel: function () {
        }
    }, SCS.init = function (a) {
        var a = b.extend({}, SCS.defaults, a), c = "", d = a.navArr;
        ...
        }), c += '</div><div class="scs_btns"><div class="scs_btn_span"></div><div class="scs_btn scs_btn_ok">确定</div><div class="scs_btn scs_btn_cancel">取消</div></div></div></div></div>', b("#cascade_scroll_selects").remove(), b("#page_foot").append(c);
        ...
        function e(b) {
            if (t = (new Date).getTime(), Math.abs(p - o) > 5 && t - s > 20) {
                var c = w, g = c > 0 ? .5 * c * c / .001 : -.5 * c * c / .001, j = Math.abs(c) / .001;
        ...
        function f(b) {
            if (m) if (t = (new Date).getTime(), Math.abs(p - o) > 5 && t - s > 20) {
                var c = w, g = c > 0 ? .5 * c * c / .001 : -.5 * c * c / .001, j = Math.abs(c) / .001;
        ...
        var g = {
                el: void 0, dataArr: [], startIndex: 0, onInit: function (a, b) {
                }, onChange: function (a, b) {
                }
            }, a = b.extend({}, g, a), h = b(a.el), i = h.get(0), j = a.dataArr, k = a.startIndex, l = this, m = !1, n = !1,
            o = 0, p = 0, q = 0, r = q, s = 0, t = 0, u = (new Date).getTime(), v = 0, w = 0, x = !0;
        try {
            ontouchstart
        } catch (y) {
            x = !1
        ...
        l.selectedIndex = k, l.getSelectedItem = function () {
            ...
            if (t = (new Date).getTime(), Math.abs(p - o) > 5 && t - s > 50) {
                var c = w, d = c > 0 ? .5 * c * c / .001 : -.5 * c * c / .001, e = Math.abs(c) / .001;
            ...
            if (n) {
                var d = b(this), e = d.position().top, f = 80 - e;
                h.css({
                    "-webkit-transition": "-webkit-transform 0s ease-out",
