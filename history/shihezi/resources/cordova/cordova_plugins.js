...
module.exports = [
    ...
    {
    	"file" : "plugins/com.jsict.mobile.plugins.des/des.js",
    	"id" : "com.jsict.mobile.plugins.des.desplugin",
    	"clobbers" : [
    	      "jsict.des"
    	 ]
    },
    {
    	"file" : "plugins/com.jsict.mobile.plugins.contacts/contacts.js",
    	"id" : "com.jsict.mobile.plugins.contacts.ContactDialogPlugin",
    	"clobbers" : [
    	      "jsict.contacts"
    	 ]
    },
    {
    	"file" : "plugins/com.jsict.mobile.plugins.jpush/jpush.js",
    	"id" : "com.jsict.mobile.plugins.jpush",
    	"clobbers" : [
    	    "jsict.jpush"
    	]
    },
    {
    	"file" : "plugins/com.jsict.mobile.plugins.alipay/alipay.js",
    	"id" : "com.jsict.mobile.plugins.alipay",
    	"clobbers" : [
    	    "jsict.alipay"
    	]
    },
    ...
    {
    	"file" : "plugins/com.jsict.mobile.plugins.yixin/yixin.js",
    	"id" : "com.jsict.mobile.plugins.yixin",
    	"clobbers" : [
    	    "jsict.yixin"
    	]
    },
    {
    	"file" : "plugins/com.jsict.mobile.plugins.weixin/weixin.js",
    	"id" : "com.jsict.mobile.plugins.weixin",
    	"clobbers" : [
    	    "jsict.weixin"
    	]
    },
    {
    	"file" : "plugins/com.jsict.mobile.plugins.weibo/weibo.js",
    	"id" : "com.jsict.mobile.plugins.weibo",
    	"clobbers" : [
    	    "jsict.weibo"
    	]
    },
...
// TOP OF METADATA
{
    ...
    "com.jsict.mobile.plugins.app.appmanager" : "1.0",
    "com.jsict.mobile.plugins.des.desplugin" : "1.0",
    "com.jsict.mobile.plugins.contacts.ContactDialogPlugin" : "1.0",
    "com.jsict.mobile.plugins.jpush" : "1.0",
    "com.jsict.mobile.plugins.alipay" : "1.0",
    "com.jsict.mobile.plugins.weibo" : "1.0",
    "com.jsict.mobile.plugins.weixin" : "1.0",
    "com.jsict.mobile.plugins.yixin" : "1.0",
    "com.jsict.mobile.plugins.utils" : "1.0"
}
// BOTTOM OF METADATA
});