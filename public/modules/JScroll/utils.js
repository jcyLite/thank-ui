...
utils.prefixPointerEvent = function(pointerEvent) {
	return window.MSPointerEvent ?
		'MSPointer' + pointerEvent.charAt(7).toUpperCase() + pointerEvent.substr(8) :
		pointerEvent;
};

utils.momentum = function(current, start, time, lowerMargin, wrapperSize, deceleration) {
...
utils.preventDefaultException = function(el, exceptions) {
