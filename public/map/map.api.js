...
window.BMAP_AUTHENTIC_KEY = "9ypVpXlrLg2aigESzOHCC5R0fisGSgiP";
...
(function() {
	...
	x.D.Nl.filter = function(a, b, c) {
		for(var d = 0, e = x.D.Nl, f; f = e[d]; d++)
			if(f = f[c]) b = f(a, b);
		return b
	};
	x.Tk.tO = function(a) {
	...
	x.UK = function() {
		...
		a.prototype = {
			...
			move: function(a) {
				...
				if(10 < Math.abs((this.zk ? a.touches[0].clientX : a.clientX) - this.gu) || 10 < Math.abs(c - this.hu)) this.ph = o
			},
			end: function(a) {
				na(a);
...
//				alert(b)
	...
	function Ka(a, b) {
		if(a = x.$(a)) {
			...
			if(-1 < navigator.userAgent.toLowerCase().indexOf("UCBrowser") || d && e) c.K.TF = 99;
			c.Va = a;
			c.yB(a);
			a.unselectable = "on";
			a.innerHTML = "";
	...
	x.extend(Ka.prototype, {
		...
		hk: function(a, b, c, d) {
			...
			if(c = c && d ? f.Ck(c, this.Xb) : this.mc)
				if(this.mc = new H(c.lng + a * e, c.lat - b * e), (a = f.oh(this.mc, this.Xb)) && g) this.Oe = a
		},
		Dg: function(a, b) {
		...
		oa: u("Jb"),
		tz: function() {
			for(var a = this.R.aF; a < z.Gr.length; a++) z.Gr[a](this);
			this.R.aF = a
		},
		qF: function(a) {
			this.Xb = Pa.tk(a);
		...
		$L: function(a) {
			a ? this.qs && this.qs.Af === a || (this.xh(this.qs), this.qs = new lb({
				geotableId: a
			}), this.Wg(this.qs)) : this.xh(this.qs)
		},
		Wb: function() {
			var a = this.fa() >= this.K.TF && this.oa() === La && 18 >= this.fa(),
				b = q;
			try {
	...
	function tb(a) {
		var b = $a();
		b >= a.Yz ? (Xa(a.k.va) && a.k.va(a.k.jc(1)), Xa(a.k.finish) && a.k.finish(), 0 < a.Zf.length && (b = a.Zf[0], b.Zf = [].concat(a.Zf.slice(1)), b.start())) : (a.xy = a.k.jc((b - a.Nu) / a.k.duration), Xa(a.k.va) && a.k.va(a.xy), a.FF || (a.Xr = setTimeout(function() {
			tb(a)
		}, 1E3 / a.k.Gc)))
	}
	...
	function(a, b, c) {
		...
		function(a, b, c) {
			function g(a) {
				if(!a.Ko) {
					for(var c = o, d = [], f = a.tZ, i = 0; f && i < f.length; i++) {
						var k = f[i],
							l = Z[k] = Z[k] || {};
			...
			if(!B || !B.Ko) {
				var A = b.all && a.attachEvent,
					E = B && B.xE || +new Date,
					C = a.q3 || (+new Date).toString(36) + Math.random().toString(36).substr(2, 3),
					D = 0,
					J = {},
					P = function(a) {
						var b = arguments,
	...
	var Rb = {
		...
		style: "hfbhis",
		tile: "sm5sdi",
		vectordrawlib: "idt2yj",
		newvectordrawlib: "01mwvd",
		groundoverlay: "g1ssmr",
	...
	x.object.extend(I, {
		...
		qL: function() {
			var a = "canvablepath",
				b = z.IU ? "newvectordrawlib" : "vectordrawlib";
		...
		Q3: {},
		iG: {
			ZP: z.ma + "getmodules?v=2.0&t=20140707",
			zU: 5E3
		},
		DC: q,
		Pd: {
		...
		lK: function(a) {
			if(a && this.qL()[a])
				for(var a = this.qL()[a], b = 0; b < a.length; b++) this.lK(a[b]), this.Pd.ul[a[b]] || this.yN(a[b])
		},
		yN: function(a) {
			for(var b = 0; b < this.Pd.Gn.length; b++)
				if(this.Pd.Gn[b] == a) return;
			this.Pd.Gn.push(a)
		},
		zZ: function(a, b) {
			var c = this.ib(a);
		...
		uV: function(a, b) {
			for(var c = this.Pd.Tv, d = o, e = 0, f = c.length; e < f; e++) "" == c[e].KE && (c[e].SM == a ? c[e].KE = b : d = q);
			d && this.WK()
		},
		WK: function() {
			for(var a = this.Pd.Tv, b = 0, c = a.length; b < c; b++) this.zZ(a[b].SM, a[b].KE);
			this.Pd.Tv.length = 0
		}
	});
	...
	x.extend(Sb.prototype, {
		...
		qc: function(a) {
			if(this.s1 || !Wa(a) || isNaN(a) || a < Tb || 3 < a) a = this.defaultAnchor;
			this.k = this.k || {
				zg: q
			};
	...
	x.extend(S, {
		...
		w2: function(a, b) {
			...
			d = this.Uk(a.lat);
			b = this.Ab(b);
			return !b ? 0 : this.Se(c, this.Uk(b.lng), d, this.Uk(b.lat))
		},
		Yo: function(a, b) {
			if(!a || !b) return 0;
			...
			return this.Se(this.Uk(a.lng), this.Uk(b.lng), this.Uk(a.lat), this.Uk(b.lat))
		},
		Ab: function(a) {
	...
	x.extend(oc.prototype, {
		...
		draw: function() {
			var a = this.map.Ue(this.z.point);
	...
	x.extend(Fc.prototype, {
		...
		Cm: function(a, b, c) {
			...
			l = 0;
			for(d = a.childNodes.length; l < d; l++) w = a.childNodes[l], w.kr = q, this.Me.push(w);
			if(l = this.Tm)
			...
			l = 0;
			for(d = this.Me.length; l < d; l++) n = this.Me[l], n.kr || this.Ne.push(n);
			this.qn = [];
			w = (e + c) * this.map.K.devicePixelRatio;
			l = 0;
			for(d = this.Qc.length; l < d; l++) A = this.Qc[l][0], i = this.Qc[l][1], t = A * e + g[0] - c / 2, v = (-1 - i) * e + g[1] - c / 2, y = k + "_" + b + "_" + A + "_" + i + "_" + f, m = this.Tm[y], n = p, m ? (n = m.style, n.left = t + "px", n.top = v + "px", m.$e || this.qn.push([A, i, m])) : (0 < this.Ne.length ? (m = this.Ne.shift(), m.getContext("2d").clearRect(-c / 2, -c / 2, w, w), n = m.style) : (m = document.createElement("canvas"), n = m.style, n.position = "absolute", n.width = e + c + "px", n.height = e + c + "px", this.Px() && (n.WebkitTransform = "scale(1.001)"), m.setAttribute("width", w), m.setAttribute("height", w), a.appendChild(m)), m.id = y, n.left = t + "px", n.top = v + "px", -1 < y.indexOf("bg") && (t = "#F3F1EC", this.map.K.Co && (t = this.map.K.Co), n.background = t ? t : ""), this.qn.push([A, i, m])), m.style.visibility = "";
			l = 0;
		...
		oI: function(a) {
			...
			for(var g = 0; g < c; g++) {
				...
				if(!i.bI && !(i.rp && !this.map.Wb() || i.lM && this.map.Wb())) {
					...
					m = w.length;
					this.qh += m;
					for(n = 0; n < m; n++) this.m_([w[n][0], w[n][1], f], t, i, a)
				}
			}
		},
		Wg: function(a) {
			...
			else if(c.Ch && this.map.Wg(c.Ch), c.rp) {
		...
		Tt: function(a) {
			var b = this.map.oa();
			if(!this.map.Wb() && (a ? this.map.K.u_ = a : a = this.map.K.u_, a))
				for(var c = p, c = "2" == z.Qy ? [z.url.proto + z.url.domain.main_domain_cdn.other[0] + "/"] : [z.url.proto + z.url.domain.main_domain_cdn.baidu[0] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[1] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[2] + "/"], d = 0, e; e = this.Nm[d]; d++)
					if(e.h_ == o) {
						b.k.$b = 18;
						e.getTilesUrl = function(b, d) {
							var e = b.x,
								e = this.map.eb.Bw(e, d).es,
								k = b.y,
								l = Qb("normal"),
								m = 1;
							this.map.Ix() && (m = 2);
	...
	Me.prototype = {
		...
		Rv: function(a) {
			...
			if(this.enabled) {
				...
				this.options.zoom && (Ae && 1 < a.touches.length) && (d = ce.abs(a.touches[0].pageX - a.touches[1].pageX), c = ce.abs(a.touches[0].pageY - a.touches[1].pageY), this.I_ = ce.sqrt(d * d + c * c), this.gy = ce.abs(a.touches[0].pageX + a.touches[1].pageX - 2 * this.VF) / 2 - this.x, this.hy = ce.abs(a.touches[0].pageY + a.touches[1].pageY - 2 * this.WF) / 2 - this.y, this.options.Bp && this.options.Bp.call(this, a));
		...
		cT: function(a) {
			...
			if(this.options.zoom && Ae && 1 < a.touches.length) e = ce.abs(a.touches[0].pageX - a.touches[1].pageX), f = ce.abs(a.touches[0].pageY - a.touches[1].pageY), this.H_ = ce.sqrt(e * e + f * f), this.Yk = o, b = 1 / this.I_ * this.H_ * this.scale, b < this.options.Xk ? b = 0.5 * this.options.Xk * Math.pow(2, b / this.options.Xk) : b > this.options.bq && (b = 2 * this.options.bq * Math.pow(0.5, this.options.bq / b)), this.vp = b / this.scale, e = this.gy - this.gy * this.vp + this.x, f = this.hy - this.hy * this.vp + this.y, this.Pb.style[le] = "translate(" + e + "px," + f + "px) scale(" + b + ")" + Le, this.options.nN && this.options.nN.call(this, a);
			else {
				this.th = b.pageX;
				this.uh = b.pageY;
				if(0 < e || e < this.he) e = this.options.Eo ? this.x + c / 2 : 0 <= e || 0 <= this.he ? 0 : this.he;
				if(f > this.rf || f < this.nd) f = this.options.Eo ? this.y + d / 2 : f >= this.rf || 0 <= this.nd ? this.rf : this.nd;
				this.NC += c;
				this.OC += d;
				this.jw = ce.abs(this.NC);
				this.kw = ce.abs(this.OC);
				6 > this.jw && 6 > this.kw || (this.options.DE && (this.jw > this.kw + 5 ? (f = this.y, d = 0) : this.kw > this.jw + 5 && (e = this.x, c = 0)), this.ph = o, this.Cr(e, f), this.HC = 0 < c ? -1 : 0 > c ? 1 : 0, this.IC = 0 < d ? -1 : 0 > d ? 1 : 0, 300 < g - this.startTime && (this.startTime = g, this.gu = this.x, this.hu = this.y), this.options.kN && this.options.kN.call(this, a))
			}
		},
		cv: function(a) {
			if(!(Ae && 0 !== a.touches.length)) {
				...
				if(b.Yk) d = b.scale * b.vp, d = Math.max(b.options.Xk, d), d = Math.min(b.options.bq, d), b.vp = d / b.scale, b.scale = d, b.x = b.gy - b.gy * b.vp + b.x, b.y = b.hy - b.hy * b.vp + b.y, b.Pb.style[oe] = "200ms", b.Pb.style[le] = "translate(" + b.x + "px," + b.y + "px) scale(" + b.scale + ")" + Le, b.Yk = q, b.refresh(), b.options.Ap && b.options.Ap.call(b, a);
				else {
					if(b.ph) {
						...
						f.Ba || g.Ba ? (c = ce.max(ce.max(f.time, g.time), 10), b.options.du && (f = d - b.lw, g = e - b.mw, ce.abs(f) < b.options.Iy && ce.abs(g) < b.options.Iy ? b.scrollTo(b.lw, b.mw, 200) : (f = b.hJ(d, e), d = f.x, e = f.y, c = ce.max(f.time, c))), b.scrollTo(ce.round(d), ce.round(e), c)) : b.options.du ? (f = d - b.lw, g = e - b.mw, ce.abs(f) < b.options.Iy && ce.abs(g) < b.options.Iy ? b.scrollTo(b.lw, b.mw, 200) : (f = b.hJ(b.x, b.y), (f.x != b.x || f.y != b.y) && b.scrollTo(f.x, f.y, f.time))) : b.ko(200)
					} else {
						if(Ae)
							if(b.GK && b.options.zoom) clearTimeout(b.GK), b.GK = p, b.options.Bp && b.options.Bp.call(b, a), b.zoom(b.th, b.uh, 1 == b.scale ? b.options.mW : 1), b.options.Ap && setTimeout(function() {
		...
		GU: function(a) {
			...
			if("zoom" == b.options.VO) {
				if(d = b.scale * Math.pow(2, 1 / 3 * (d ? d / Math.abs(d) : 0)), d < b.options.Xk && (d = b.options.Xk), d > b.options.bq && (d = b.options.bq), d != b.scale) !b.Sy && b.options.Bp && b.options.Bp.call(b, a), b.Sy++, b.zoom(a.pageX, a.pageY, d, 400), setTimeout(function() {
					b.Sy--;
					!b.Sy && b.options.Ap && b.options.Ap.call(b, a)
				}, 400)
			} else c = b.x + c, d = b.y + d, 0 < c ? c = 0 : c < b.he && (c = b.he), d > b.rf ? d = b.rf : d < b.nd && (d = b.nd), 0 > b.nd && b.scrollTo(c, d, 0)
		},
		CU: function(a) {
		...
		hJ: function(a, b) {
			...
			a = this.Te[e];
			d = (d = ce.abs(a - this.Te[this.yC])) ? 500 * (ce.abs(this.x - a) / d) : 0;
			this.yC = e;
			e = this.uf.length - 1;
			for(c = 0; c < e; c++)
				if(b >= this.uf[c]) {
		...
		refresh: function() {
			...
			if("string" == typeof this.options.du) {
				...
				a = 0;
				for(b = c.length; a < b; a++) d = this.Zj(c[a]), d.left += this.VF, d.top += this.WF, this.Te[a] = d.left < this.he ? this.he : d.left * this.scale, this.uf[a] = d.top < this.nd ? this.nd : d.top * this.scale
			} else if(this.options.du) {
				for(this.Te = []; d >= this.he;) this.Te[b] = d, d -= this.vu, b++;
				this.he % this.vu && (this.Te[this.Te.length] = this.he - this.Te[this.Te.length - 1] + this.Te[this.Te.length - 1]);
				b = d = 0;
		...
		scrollTo: function(a, b, c, d) {
			...
			a = 0;
			for(b = e.length; a < b; a++) e[a].nZ && (e[a].x = this.x - e[a].x, e[a].y = this.y - e[a].y), this.Aj.push({
				x: e[a].x,
				y: e[a].y,
				time: e[a].time || 0
			});
		...
		zoom: function(a, b, c, d) {
			var e = c / this.scale;
			this.options.Vk && (this.Yk = o, d = d === j ? 200 : d, a = a - this.VF - this.x, b = b - this.WF - this.y, this.x = a - a * e + this.x, this.y = b - b * e + this.y, this.scale = c, this.refresh(), this.x = 0 < this.x ? 0 : this.x < this.he ? this.he : this.x, this.y = this.y > this.rf ? this.rf : this.y < this.nd ? this.nd : this.y, this.Pb.style[oe] = d + "ms", this.Pb.style[le] = "translate(" + this.x + "px," + this.y + "px) scale(" + c + ")" + Le, this.Yk = q)
		}
	};
	...
	x.extend(Ne.prototype, {
		...
		QV: function() {
			if(this.Ki) a = this.lL(this.Ni), this.sQ.innerHTML = a;
			else {
				var a = this.lL(this.Ni),
					b = K("ul"),
					c = this;
				...
				x.M(b, "click", function(a) {
					if(a = (a.srcElement || a.target).getAttribute("dataindex")) {
						c.Gl(c.VG[a]);
						for(var d = b.getElementsByTagName("li"), e = 0, f = d.length; e < f; e++) d[e].childNodes[0].getAttribute("dataindex") === a ? x.D.Ua(d[e], "pano_catlogLiActive") : x.D.Tb(d[e], "pano_catlogLiActive")
					}
				});
				var a = K("div"),
					d = K("a"),
		...
		Gl: function(a) {
			this.$j = a;
			this.k.showCatalog && (0 < this.Ni.length ? (Ua() ? this.QV() : this.TV(), this.Oc.offsetLeft = 60) : (this.Ls && (this.B.removeChild(this.Ls), this.Ls = p, this.Oc.fg.style.left = "0px"), this.Ki && (this.B.removeChild(this.Ki), this.Ki = p), this.Oc.offsetLeft = 0));
			var b = this.hX(a);
			Ua() && (this.Ni && 0 < this.Ni.length && this.k.showExit && this.Zz) && (this.Oc.offsetLeft += this.eg.width + 8, this.Ls ? this.Ls.innerHTML = this.Zz : this.RV());
			this.Wh.innerHTML = b;
			...
			a = this.EH(this.P.Zb(), this.i1); - 1 !== a && this.Pp(a)
		},
		nX: function(a) {
