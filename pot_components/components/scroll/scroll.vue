<template>
  <div ref="wrapper" class="pot-scroll-wrapper">
    <div class="pot-scroll-content">
      <div ref="listWrapper" class="pot-scroll-list-wrapper">
        <slot>
          <ul class="pot-scroll-list">
            <li
              class="pot-scroll-item border-bottom-1px"
      ...
      <slot name="pullup" :pullUpLoad="pullUpLoad" :isPullUpLoad="isPullUpLoad">
        <div class="pot-pullup-wrapper" v-if="pullUpLoad">
    ...
    <div v-if="pullDownRefresh" class="pot-pulldown" ref="pulldown">
      <slot
        name="pulldown"
        ...
        :bubbleY="bubbleY">
        <div class="pot-pulldown-wrapper" :style="pullDownStyle">
