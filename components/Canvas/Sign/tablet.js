	...
	return {
		init: function(opt) {
			...
			if(typeof opt.color == "string") {
				...
				if(opt.color.r != undefined && opt.color.g != undefined && opt.color.b != undefined) {
					opt.color = rgbToHsb(opt.color)
				} else {
					if(opt.color.h != undefined && opt.color.s != undefined && opt.color.b != undefined) {
			...
			if(col != undefined) {
				...
				if(typeof col == "string") {
					...
					if(col.r != undefined && col.g != undefined && col.b != undefined) {
						...
						if(col.h != undefined && col.s != undefined && col.b != undefined) {
							col = fixHSB(col)
						} else {
							return this
						}
